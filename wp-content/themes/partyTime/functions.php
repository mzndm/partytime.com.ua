...
// remove In Header Tags and Links
...
function add_image_sizes() {
    add_image_size( 'gallery-primary', 1200, 574 );
    add_image_size( 'gallery-secondary', 281, 178 );
}
 ...
 *
 * 2.4
 * ADD: php в постах или страницах WordPress: [exec]код[/exec]
 *
 * 2.3
