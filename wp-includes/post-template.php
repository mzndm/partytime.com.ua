...
function the_meta() {
	if ( $keys = get_post_custom_keys() ) {
		echo "<section class='wrap background-f8'>\n";
		foreach ( (array) $keys as $key ) {
			 ...
			 */
			echo apply_filters( 'the_meta_key', "<div class='container'><h1 class='section-header__p'>$key</h1>
			<div class='wrap__item-text'><div class='wrap__item-text-content'><p>$value</p></div>
			<span class='wrap__item-btn' style='display: inline;'>Подробнее</span></div></div>\n", $key, $value );
		}
		echo "</section>\n";
	}
}
